...
示例：general/v2/`,
    ...
    fileManager: {
      ...
      canManageDesc:
        '可查看、下载、编辑、上传、创建文件夹、删除、重命名、移动、分享',
      ...
      // 团队共享
      shareToTeam: '共享给团队',
      teamShareEnabledDesc: '所有团队成员均可访问此文件',
      teamShareDisabledDesc: '仅你自己可以访问此文件',
      teamShareEnabled: '已共享给所有团队成员',
      teamShareDisabled: '已关闭团队共享',
      teamShareEnableFailed: '启用团队共享失败',
      teamShareDisableFailed: '关闭团队共享失败',
      enableTeamShare: '开启团队共享',
      disableTeamShare: '关闭团队共享',
      teamPermissionLevel: '权限级别',
      teamPermissionLevelDesc: '设置所有团队成员的权限级别',
      teamPermissionUpdated: '团队权限级别已更新',
      teamPermissionUpdateFailed: '更新团队权限级别失败',
      sharedToTeam: '已共享给团队',
      privateFile: '私有',
      failedToLoadTeamShareStatus: '加载团队共享状态失败',
      noPermissionToManage: '您没有管理共享的权限',
      ...
      privateFolder: '私有文件夹',
      includesSubfolders: '包含子文件夹',
      includeSubfolders: '包含子文件夹',
      teamShareSubfoldersUpdated: '子文件夹设置已更新',
      teamShareSubfoldersUpdateFailed: '更新子文件夹设置失败',
      permissionDescriptions: '权限说明',
    },
    flow: {
      preprocess: {
        preprocess: '预处理',
...
[在此处插入文本]`,
    ...
    admin: {
      systemConfig: {
        title: '系统配置',
        description: '管理系统级配置，包括OAuth认证和默认模型设置',
        configurationTitle: '配置管理',
        configurationDescription: '配置系统行为，变更立即生效',
        dingtalkTab: '钉钉OAuth配置',
        modelTab: '默认模型配置',
        dingtalkSectionTitle: '钉钉OAuth设置',
        dingtalkSectionDescription:
          '配置钉钉OAuth认证，启用后用户可使用钉钉账号登录',
        modelSectionTitle: '默认模型提供商设置',
        modelSectionDescription: '配置默认的LLM模型提供商，用于新创建的数据集',
        saveButton: '保存配置',
        savingButton: '保存中...',
        validateButton: '验证配置',
        validatingButton: '验证中...',
        note: '注意：配置变更会立即生效，无需重启服务',

        dingtalk: {
          appKeyLabel: 'App Key',
          appKeyPlaceholder: '请输入钉钉开放平台的App Key',
          appKeyDescription: '在钉钉开放平台创建应用后获取',
          appSecretLabel: 'App Secret',
          appSecretPlaceholder: '请输入钉钉开放平台的App Secret',
          appSecretDescription: '与App Key配对，请妥善保管',
          redirectUriLabel: '回调地址',
          redirectUriPlaceholder: 'https://your-domain.com/oauth/callback',
          redirectUriDescription: '钉钉OAuth认证成功后回调的地址',
          enabledLabel: '启用钉钉登录',
          enabledDescription: '启用后登录页面将显示钉钉登录按钮',
        },

        model: {
          providerLabel: '模型提供商',
          providerPlaceholder: '请选择模型提供商',
          providerDescription: '选择默认的LLM模型提供商',
          apiKeyLabel: 'API Key',
          apiKeyPlaceholder: '请输入模型提供商的API Key',
          apiKeyDescription: '模型提供商的API密钥',
          baseUrlLabel: 'Base URL',
          baseUrlPlaceholder: 'https://api.openai.com/v1',
          baseUrlDescription: 'API请求的基础URL地址',
          defaultModelLabel: '默认模型',
          defaultModelPlaceholder: '例如：gpt-4o-mini',
          defaultModelDescription: '新数据集默认使用的模型',
          enabledLabel: '启用默认模型',
          enabledDescription: '启用后新数据集将使用此默认模型',
        },
      },
    },
