...
Example: Virtual Hosted Style`,
    ...
    fileManager: {
      ...
      shareFileDescription: 'Share "{{name}}" with others',
      addPeople: 'Add people',
      searchUsers: 'Search users by name or email',
      peopleWithAccess: 'People with access',
      noSharedUsers: 'No one has access to this file yet',
      inheritedPermissions: 'Inherited from parent folder',
      inheritedFrom: 'Inherited from "{{name}}"',
      permissionLevels: 'Permission levels',
      selectUserToShare: 'Please select a user to share with',
      shareSuccess: 'File shared with {{count}} user(s) successfully',
      ...
      selectedUsers: 'Selected: {{count}} user(s)',
      clearSelection: 'Clear',
      failedToLoadPermissions: 'Failed to load permissions',
      // Team share
      shareToTeam: 'Share with team',
      teamShareEnabledDesc: 'All team members can access this file',
      teamShareDisabledDesc: 'Only you can access this file',
      teamShareEnabled: 'Shared with the entire team',
      teamShareDisabled: 'Team sharing disabled',
      teamShareEnableFailed: 'Failed to enable team sharing',
      teamShareDisableFailed: 'Failed to disable team sharing',
      enableTeamShare: 'Enable team sharing',
      disableTeamShare: 'Disable team sharing',
      teamPermissionLevel: 'Permission level',
      teamPermissionLevelDesc: 'Set the permission level for all team members',
      teamPermissionUpdated: 'Team permission level updated',
      teamPermissionUpdateFailed: 'Failed to update team permission level',
      sharedToTeam: 'Shared with team',
      privateFile: 'Private',
      failedToLoadTeamShareStatus: 'Failed to load team share status',
      noPermissionToManage: 'You do not have permission to manage sharing',
      shareFolder: 'Share folder',
      shareFolderDescription: 'Share this folder with your entire team',
      shareFolderToTeam: 'Share folder with team',
      folderTeamShareEnabledDesc:
        'All team members can access this folder and its contents',
      folderTeamShareDisabledDesc:
        'Only you can access this folder and its contents',
      folderPermissionLevel: 'Permission level',
      folderPermissionLevelDesc:
        'Set the permission level for all team members for this folder',
      ...
      teamShareSubfoldersUpdated: 'Subfolder settings updated',
      teamShareSubfoldersUpdateFailed: 'Failed to update subfolder settings',
      permissionDescriptions: 'Permission descriptions',
    },
    flow: {
      preprocess: {
