...
export default {
  ...
  // file permission
  createFileShare: `${webAPI}/file_permission/share`,
  listFileShares: `${webAPI}/file_permission/list`,
  updateFileShare: `${webAPI}/file_permission/update`,
  revokeFileShare: `${webAPI}/file_permission/revoke`,
  sharedWithMe: `${webAPI}/file_permission/shared_with_me`,
  sharedByMe: `${webAPI}/file_permission/shared_by_me`,
  batchFileShare: `${webAPI}/file_permission/batch_share`,
  checkFilePermission: `${webAPI}/file_permission/check`,
  shareableUsers: `${webAPI}/file_permission/shareable_users`,

  // team file permission
  enableTeamShare: `${webAPI}/file_permission/team/enable`,
  disableTeamShare: `${webAPI}/file_permission/team/disable`,
  getTeamShareStatus: `${webAPI}/file_permission/team/status`,
  updateTeamPermissionLevel: `${webAPI}/file_permission/team/level`,
